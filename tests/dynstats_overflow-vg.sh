...
. $srcdir/diag.sh content-check "quux 007 -2000"
. $srcdir/diag.sh content-check "corge 008 -2000"
. $srcdir/diag.sh content-check "quux 009 -2000"
. $srcdir/diag.sh content-check "foo 010 0"
. $srcdir/diag.sh content-check "corge 011 -2000"
. $srcdir/diag.sh content-check "grault 012 -2000"
...
. $srcdir/diag.sh content-check "foo 017 -2000"
